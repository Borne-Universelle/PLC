...
RessortRoyal::RessortRoyal(){
    ...
    targetPositionRached     = (BooleanOutputNode *)BorneUniverselle::findNode(CONSTR_RESSORT_ROYAL, TARGET_POSITION_REACHED);
...
void RessortRoyal::displayAlarmsAndStatus(){
    ...
    targetPositionRached ->setValue(status->getValue() &  0b0000000000010000);
